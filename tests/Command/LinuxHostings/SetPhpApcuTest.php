...
use TomCan\CombellApi\Command\LinuxHostings\SetPhpApcu;

final class SetPhpApcuTest extends TestCase
{
    public function testSetPhpApcu(): void
    {
        $returnValue = [
            'status' => 204,
            'headers' => [
        ...
        $adapterStub->method('call')
            ->with('PUT', 'https://api.combell.com/v2/linuxhostings/example.com/phpsettings/apcu', $headers, '{"apcu_size":64,"enabled":true}')
        ...
        $cmd = new SetPhpApcu('example.com', 64, true);
